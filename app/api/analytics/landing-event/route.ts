...
const ALLOWED = new Set(["VISIT", "TIME_SPENT", "GYM_OPENED", "WEBSITE_CLICKED", "FAVORITE_ADDED", "FAVORITE_REMOVED", "COMPARE_ADDED", "COMPARE_REMOVED", "COMPARE_OPENED", "DAY_PASS_CLICKED", "DAY_PASS_CLAIM_CONFIRMED", "DAY_PASS_CLAIM_DECLINED", "FILTER_OPENED", "FILTER_CHANGED", "FILTER_CLEARED", "LOCATION_SEARCHED", "LOCATION_USED", "SORT_CHANGED", "MAP_VIEWED", "LIST_VIEWED"]);
