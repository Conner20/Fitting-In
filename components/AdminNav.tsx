...
const items = [{ href: "/admin", label: "Users", key: "users" }, { href: "/admin/gyms", label: "Gyms", key: "gyms" }, { href: "/admin/metrics", label: "Metrics", key: "metrics" }, { href: "/admin/behavior", label: "User behavior", key: "behavior" }, { href: "/admin/nutrition", label: "Nutrition", key: "nutrition" }] as const;
