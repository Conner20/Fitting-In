...
export default function AdminGymListingEditor({ gymId, inviteToken, initialGym, autoClaim = false, ownerMode = false }: { gymId?: string; inviteToken?: string; initialGym?: Record<string, any>; autoClaim?: boolean; ownerMode?: boolean }) {
    ...
    function populate(gym: Record<string, any>) {
        ...
        if (!membershipOptions.length && gym.membershipPrice != null) membershipOptions.push({ id: crypto.randomUUID(), name: "Membership", price: Number(gym.membershipPrice), billingFrequency: "monthly", billingInterval: 1, billingIntervalUnit: "months", contractLength: 1, contractLengthUnit: "months", enrollmentFee: 0, annualFee: 0, additionalFees: 0, additionalFeesDetails: "", access: [], purchaseUrl: gym.website ?? "", notes: gym.membershipDetails ?? "" });
