...
<button type="button" data-confirming={deleteArmed?"true":"false"} onClick={()=>void remove()} disabled={!selected.length} className="admin-delete-selected flex items-center gap-2 rounded-xl !bg-red-600 px-4 py-2.5 text-sm font-semibold !text-white transition hover:!bg-red-600 active:!bg-red-600 focus:!bg-red-600 disabled:opacity-40">
<Trash2 className="h-4 w-4"/>{deleteArmed?"Are you sure?":"Delete selected"}</button>
